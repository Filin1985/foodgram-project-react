...
class FavoriteApiView(APIView):
    ...
    def post(self, request, id):
        serializer = post_favorite_cart(FavoriteSerializer, request, id)
        return Response(serializer.data, status=status.HTTP_201_CREATED)

    def delete(self, request, id):
        delete_favorite_cart(request, id, Favorite, Recipe)
...
class CartListApiView(APIView):
    ...
    def post(self, request, id):
        serializer = post_favorite_cart(CartListSerializer, request, id)
        return Response(serializer.data, status=status.HTTP_201_CREATED)

    def delete(self, request, id):
        delete_favorite_cart(request, id, CartList, Recipe)
        return Response(status=status.HTTP_204_NO_CONTENT)
